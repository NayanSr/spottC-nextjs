  ...
  return (
    <>
                ...
                <CarouselItem key={event._id}>
                  ...
                  >
                    ...
                    <div className="relative h-full flex flex-col justify-end p-8 md:p-12 ">
                      ...
                      <p className="text-lg text-white/60 mb-4 max-w-2xl line-clamp-2">
                        {event.description}
                      </p>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p>Happening in {currentUser?.location.city || "Yor area"}</p>
            </div>
            <Button
              variant="outline"
              className="gap-2"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {categoriesWithCounts.map((category) => (
            <Card
              ...
              className="py-2 group cursor-pointer hover:shadow-lg translate-all hover:border-purple-500/50"
            >
              <CardContent className="px-3 sm:p-6 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {category.count} Event {category.count !== 1 ? "$" : ""}
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      {popularEvents && popularEvents.length > 0 &&(
        <div className="mb-16">
          <div className="mb-6">
            <h2 className="text-3xl font-bold mb-1">Pooular Across India</h2>
            <p className="text-muted-foreground"> Tending events nationwide</p>
          </div>
